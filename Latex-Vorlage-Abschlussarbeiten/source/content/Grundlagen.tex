...
Sie sehen, dass um das \textit{tabular} ein \textit{table}-Element eingefügt wurde. Mit diesem können Sie die Tabelle platzieren und den Umbruch bestimmen. Diese Tabelle taucht auch im Tabellenverzeichnis am Anfang der Arbeit auf! Nutzen Sie dafür \textit{caption}.
