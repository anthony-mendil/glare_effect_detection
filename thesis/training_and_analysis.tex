...
\end{figure}
\todo{vielleicht darstellung anpassen, damit die gleichen diemsionsnen das gleiche bedeutet wie bei 2d cnn, mit feature maps und so}
...
\begin{table}[H]
	...
	\begin{tabular}{|c||ccccc|ccccc|ccccc|ccccc|}
		...
		sd20x &&    \textcolor{mygreen}{73.0\%} && 0.5833 &&& 76.63\% && 0.5486 &&& 79.75\% && 0.5064 &&& 84.88\% && 04704 &\\
		\hline
	\end{tabular}
	}
\end{table}
